...
function Youtube() {
  ...
  useEffect(() => {
    fetch(
      "https://www.googleapis.com/youtube/v3/search?key=AIzaSyBu2XtIRwqmcoe3gk1hDTBLDMyeFhaEj6w&channelId=UCE_M8A5yxnLfW0KghEeajjw&part=snippet,id&order=date&maxResults=8"
    )
